      ...
      return (
        <Navbar bg="dark" expand="lg" variant="pills dark" className="transparent ">
            <LinkContainer to={`/${this.state.currentPage !== 0? this.state.pages[this.state.currentPage-1]: 'about'}` }>
                <Nav.Item className="mr-2 ml-2 navIcon btn" onClick={()=>{this.pageBack()}}><img className="mr-1 ml-1 " src="./images/fontawesome-free-5.7.2-web/svgs/regular/caret-square-left.svg" width="20"alt="twitter icon"></img></Nav.Item>
              </LinkContainer>
            <Navbar.Brand>
                <h3>Kevin Ziechmann</h3>
            </Navbar.Brand>
            <LinkContainer to={`/${this.state.currentPage !== 0? this.state.pages[this.state.currentPage]: 'websites'}` }>
                <Nav.Item className="mr-2 ml-2 navIcon btn" onClick={()=>{this.pageForward()}}><img className="mr-1 ml-1 " src="./images/fontawesome-free-5.7.2-web/svgs/regular/caret-square-right.svg" width="20"alt="twitter icon"></img></Nav.Item>
              </LinkContainer>
